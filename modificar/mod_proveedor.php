...
extract($_POST);
    ...
    $sql1="select * from proveedor where nit= '$codigo'";
...
<div class="divform">
	...
	<form id= "form" action="m_proveedor.php" method="post" onSubmit=" return verificar_enviar(this);">
	<table>
	<tr valign="middle" align="center">
	<td colspan="2">
	<table  align="center" width="100%"><tr valign="top"><td >
	<p align="center"><label for="codigo"> Nit:</label><br/>
	<input type="text"  name="nit" readonly value="<?PHP echo $codigo;?>" onChange="verificacodigo(this);"></p>
	</td>
	<td >
	<p align="center"><label for="codigo"> Empresa:</label><br/>
	<input type="text"  name="empresa" onKeyPress="return soloLetras(event);" value="<?PHP echo $empresa;?>" onKeyUp="aMayusculas(this);"></p>
	</td>
	</tr>
	<tr>
	<td colspan="2">
	...
	<input type="text" name="apellido1" value="<?PHP echo $apellido_uno; ?>" onKeyPress="return soloLetras(event);" onKeyUp="aMayusculas(this);"></p>
	</td>
	
	<td>
	<p align="center"><label for="apellido2"> Segundo Apellido:</label><br/>
	<input type="text" name="apellido2" value="<?PHP echo $apellido_dos; ?>" onKeyPress="return soloLetras(event);" onKeyUp="aMayusculas(this);"></p>
	</td>
	...
	<input type="text" name="direccion" value="<?PHP echo $direccion; ?>" onKeyUp="aMayusculas(this);"></p>
	</td>
	</tr>
	<tr>
	<td colspan="2">
	<p align="center"><label for="email"> Email:</label><br/>
	<input type="email" name="email" value="<?PHP echo $email; ?>" onChange="verificaemail(this);"></p>
	</td>
	</tr>
	<tr>
	<td>
	<p align="center"><label for="telefono"> Telefono:</label><br/>
	<input type="tel" name="telefono" value="<?PHP echo $telefono; ?>" onChange="verificatel(this);"></p>
	</td>
	<td>
	<p align="center"><label for="celular"> Celular:</label><br/>
	<input type="tel" name="celular" value="<?PHP echo $celular; ?>" onChange="verificacel(this);"></p>
	</td>
	</tr>
	<tr>
	<td colspan="2">
...
<?PHP 
 						...
 						echo "</table> ";
						echo "<FORM ACTION='cons_proveedor.php' METHOD='POST'> <P align='center'><input width='30%' class='button cons_but' type='submit' value='Cancelar'></p>
												  </FORM>";	
					}
				else 

					{
											...
											echo "<table width='100%'><FORM ACTION='cons_proveedor.php' METHOD='POST'><tr><td>
