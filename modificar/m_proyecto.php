...
<div>
<?PHP 
$sql="UPDATE $tabla SET fecha_inicio='$fecha_inicio', fecha_entrega='$fecha_entrega', valor='$valor', descripcion='$descripcion', cod_factura='$factura' WHERE codigo='$codigo'";
