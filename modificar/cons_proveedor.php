...
<head>
	...
	<meta charset="utf-8">
	<title>Modificacion Proveedor </title>
...
<TABLE  width="90%" border="2">
	<form method="POST" action="mod_proveedor.php" onSubmit="return verificar_enviar_s(this);">
	<TR>
		<TD align="center"> NIT PROVEEDOR: <input type="text" name="codigo"  maxlength="10" size="25" onChange="validarSiNumero(this);">
		</TD>
	</tr>
	<tr>
		<TD align="center">
