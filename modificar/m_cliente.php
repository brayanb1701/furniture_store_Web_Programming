...
<div>
<?PHP 
$sql="UPDATE $tabla SET nombre='$nombre', apellido_uno='$apellido1', apellido_dos='$apellido2', direccion='$direccion', email='$email', telefono='$telefono', celular='$celular', genero='$genero', municipio='$municipio' WHERE codigo='$codigo'";
