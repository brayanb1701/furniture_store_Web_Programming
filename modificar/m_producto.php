...
<div>
<?PHP 
$sql="UPDATE $tabla SET nombre='$nombre', valor='$valor', detalles='$detalles', cod_tipo_producto='$tipo_producto', cod_tipo_derivado='$tipo_derivado', cod_tipo_madera='$color_madera' WHERE codigo='$codigo'";
