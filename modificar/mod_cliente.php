...
<?PHP 
 						...
 						echo "</table> ";
						echo "<FORM ACTION='cons_cliente.php' METHOD='POST'> <P align='center'><input width='30%' class='button cons_but' type='submit' value='Cancelar'></p>
												  </FORM>";	
					}
				else 

					{
											...
											echo "<table width='100%'><FORM ACTION='cons_cliente.php' METHOD='POST'><tr><td>
