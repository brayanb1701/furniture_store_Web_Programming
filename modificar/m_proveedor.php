...
<div>
<?PHP 
$sql="UPDATE $tabla SET nombre='$nombre', apellido_uno='$apellido1', apellido_dos='$apellido2', direccion_empresa='$direccion', email='$email', telefono='$telefono', celular='$celular', cod_genero='$genero', cod_municipio='$municipio' WHERE nit='$nit'";
