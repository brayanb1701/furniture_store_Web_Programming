...
$nombre=$_POST["nombre"];
$valor=$_POST["valor"];
$cod_tipo_producto=$_POST["tipo_producto"];
$cod_tipo_derivado=$_POST["tipo_derivado"];
$cod_tipo_madera=$_POST["color_madera"];
$detalles=$_POST["detalles"];

$conexion = pg_connect("host=localhost user=postgres port=5432 dbname=moretti password=123456"); 

$sql3="INSERT INTO producto(codigo, nombre, valor, detalles, cod_tipo_producto, cod_tipo_derivado, cod_tipo_madera) values ('$codigo','$nombre', '$valor','$detalles','$cod_tipo_producto','$cod_tipo_derivado', '$cod_tipo_madera')";

	$result = pg_query($conexion, $sql3);			

if($result){
	header("Location:producto.php?mensaje=Operacion exitosa");
	exit();
	}
	else{
...
?>
	<meta charset="utf-8">
	<title> Producto </title>	<link rel="stylesheet" href="../CSS/fonts.css">
...
<table width="100%" cellspacing="20">
	...
	<tr valign="top">
	<td>
	<p align="center">Tipo producto:<br/>
	<?PHP echo $cod_tipo_producto; ?></p>
	</td>
	<td>
	<p align="center">Tipo derivado:<br/>
	<?PHP echo $cod_tipo_derivado; ?></p>
	</td>
	<td>
	<p align="center">color_madera:<br/>
	<?PHP echo $cod_tipo_madera; ?></p>
	</td>
	</tr>
	<tr valign="top">
	<td colspan="3">
	...
	<tr>
	<td colspan="2" align="center"> <form action="producto.php" method="post"><input class="button2" type="submit" value="Regresar"></form>
