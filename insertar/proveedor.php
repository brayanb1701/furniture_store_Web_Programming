...
<div class="cuerpo">
	...
	<form id= "form" action="proveedor2.php" method="post" onSubmit=" return verificar_enviar(this);">
	<table>
	<tr valign="middle" align="center">
	<td colspan="2">
	<table  align="center" width="100%"><tr valign="top"><td >
	<p align="center"><label for="codigo"> Nit:</label><br/>
	<input type="text"  name="nit" onChange="verificacodigo(this);"></p>
	</td>
	<td >
	<p align="center"><label for="codigo"> Empresa:</label><br/>
	<input type="text"  name="empresa" onKeyPress="return soloLetras(event);" onKeyUp="aMayusculas(this);"></p>
	</td>
	</tr>
	<tr>
	<td colspan="2">
