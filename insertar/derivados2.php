...
$tipo_derivado=$_POST["tipo_derivado"];

$conexion = pg_connect("host=localhost user=postgres port=5432 dbname=moretti password=123456"); 

$sql3="INSERT INTO derivados(codigo, nombre, valor, cantidad_existente, tipo_derivado) values ('$codigo','$nombre', '$valor','$cantidad_existente','$tipo_derivado')";

	$result = pg_query($conexion, $sql3);			
if($result){
	header("Location:derivados.php?mensaje=Operacion exitosa");
	exit();
	}
	else{
	header("Location:derivados.php?mensaje=Error");
	exit();
	}
?>
	<meta charset="utf-8">
...
<table width="100%" cellspacing="20">
	...
	<tr valign="top">
	<td>
	<p align="center">Cantidad Existente:<br/>
	<?PHP echo $cantidad_existente; ?></p>
	</td>
	<td>&nbsp;</td>
	<td>
	<p align="center">Tipo derivado:<br/>
	<?PHP echo $tipo_derivado; ?></p>
	</td>
	</tr>
	...
	<tr>
	<td colspan="2" align="center"> <form action="derivados.php" method="post"><input class="button2" type="submit" value="Regresar"></form>
