...
$sql3="INSERT INTO empleado(id, nombre, apellido_uno, apellido_dos, direccion, email, telefono, celular, genero, municipio) values ('$codigo','$nombre','$apellido_uno','$apellido_dos','$direccion', '$email','$telefono','$celular', '$cod_genero','$cod_municipio')";

$result = pg_query($conexion, $sql3);	
if($result){
	header("Location:empleados.php?mensaje=Operacion exitosa");
	exit();
	}
	else{
...
?>
	<meta charset="utf-8">
	<title> Empleados </title>	<link rel="stylesheet" href="../CSS/fonts.css">
...
<table width="100%" cellspacing="20">
	...
	<tr>
	<td colspan="2" align="center"> <form action="empleados.php" method="post"><input class="button2" type="submit" value="Regresar"></form>
