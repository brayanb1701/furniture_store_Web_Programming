...
<div class="cuerpo">
	<div class="divform">
		...
		<p align="center">Llene el siguiente formulario con la información del Servicios.</p>
	
	<form id="form" action="servicios2.php" method="post" onSubmit=" return verificar_enviar5(this);">
	<table>
