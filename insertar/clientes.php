...
<div class="cuerpo">
	...
	<h2 align ="center">Clientes</h2> 
		...
		<form class="form" id="form" action="clientes2.php" method="post" onSubmit=" return verificar_enviar(this);">
			...
			<input type="text" name="apellido2" onKeyPress="return soloLetras(event);" onKeyUp="aMayusculas(this);"></p>
			<p><label for="direccion"> Dirección:</label><br/>
			<input type="text" name="direccion" onKeyUp="aMayusculas(this);"></p>
			<p><label for="email"> Email:</label><br/>
			<input type="email" name="email" onChange="verificaemail(this);"></p>
			<p><label for="telefono"> Telefono:</label><br/>
			<input type="tel" name="telefono" onChange="verificatel(this);"></p>
			<p><label for="celular"> Celular:</label><br/>
			<input type="tel" name="celular" onChange="verificacel(this);"></p>
			...
			<select id="municipio" name="municipio" ><option value="" selected>Seleccione su Municipio</option>
			<?PHP
