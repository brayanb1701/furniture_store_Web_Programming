...
<head>
	...
	<meta charset="utf-8">
	<title>Eliminacion Derivados </title>
...
<div class="cuerpo">
<h1 align="center">Eliminar Derivados</h1>
<div align="center">
<?PHP
// llamar la funciones 
   include("../conec.php");
	...
	$numrows5 = pg_numrows($result);
				if  ($numrows5!=0) 
					{   
						...
						echo "<tr align='center'><th >Codigo</th><th >Nombre</th><th >Valor</th><th>Cantidad Existente</th><th>Tipo Derivado</th></tr>";	
						while ($row1=pg_fetch_array($result)) 
							{ 
											...
											$cantidad=$row1["3"];
											$tipod=$row1["4"];
											echo "<tr  align='center'><td >".$codigo."</td><td >".$nombre."</td><td>".$valor."</td><td >".$cantidad."</td><td >".$tipod."</td></tr>";	
...
echo "<div class='cons2'><p>Rotar el dispositivo para poder observar los datos de la consulta</p></div><br/>";
						echo "<FORM ACTION='eliminar.php' METHOD='POST'>
												  <P align='center'><input type='hidden' name='tabla' value='derivados'><input type='hidden' name='codigo' value='$codigo'><input width='30%' class='button' type='submit' value='Eliminar'></p>
												  </FORM>
...

					{
											...
											echo "<table width='50%'><FORM ACTION='cons_derivados.php' METHOD='POST'><tr><td>
												  <P align='center'>NO HAY DATOS DE DERIVADOS</p></td></tr>
