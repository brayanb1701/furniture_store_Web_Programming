...
<head>
	...
	<meta charset="utf-8">
	<title>Eliminacion Empleado </title>
...
<div class="cuerpo">
<h1 align="center">Eliminar Empleado</h1>
<div align="center">
<?PHP
// llamar la funciones 
   include("../conec.php");
...
echo "<div class='cons2'><p>Rotar el dispositivo para poder observar los datos de la consulta</p></div><br/>";
						echo "<FORM ACTION='eliminar2.php' METHOD='POST'>
												  <P align='center'><input type='hidden' name='tabla' value='empleado'><input type='hidden' name='codigo' value='$codigo'><input width='30%' class='button' type='submit' value='Eliminar'></p>
												  </FORM>
...

					{
											...
											echo "<table width='50%'><FORM ACTION='cons_empleado.php' METHOD='POST'><tr><td>
												  <P align='center'>NO HAY DATOS DE EMPLEADO</p></td></tr>
