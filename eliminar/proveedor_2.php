...
<head>
	...
	<meta charset="utf-8">
	<title>Eliminacion Proveedor </title>
	...
	$numrows5 = pg_numrows($result);
				if  ($numrows5!=0) 
					{   
						...
						echo "<tr align='center'><th >Nit</th><th >Empresa</th><th >Nombre</th><th>Apellido Uno</th><th>Apellido Dos</th><th>Direccion</th><th>Email</th><th>Telefono</th><th>Celular</th><th>Cod. Genero</th><th>Cod. Municipio</th></tr>";	
						while ($row1=pg_fetch_array($result)) 
							{ 
											...
											$genero=$row1["9"];
											$municipio=$row1["10"];
											echo "<tr  align='center'><td >".$codigo."</td><td >".$empresa."</td><td >".$nombre."</td><td>".$apellido_uno."</td><td>".$apellido_dos."</td><td>".$direccion."</td><td>".$email."</td><td>".$telefono."</td><td>".$celular."</td><td>".$genero."</td><td>".$municipio."</td></tr>";	
...
echo "<div class='cons2'><p>Rotar el dispositivo para poder observar los datos de la consulta</p></div><br/>";
						echo "<FORM ACTION='eliminar3.php' METHOD='POST'>
												  <P align='center'><input type='hidden' name='tabla' value='proveedor'><input type='hidden' name='codigo' value='$codigo'><input width='30%' class='button' type='submit' value='Eliminar'></p>
												  </FORM>
...

					{
											...
											echo "<table width='50%'><FORM ACTION='cons_proveedor.php' METHOD='POST'><tr><td>
												  <P align='center'>NO HAY DATOS DE PROVEEDOR</p></td></tr>
