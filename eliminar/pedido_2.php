...
<head>
	...
	<meta charset="utf-8">
	<title>Eliminacion Pedido </title>
	...
	$numrows5 = pg_numrows($result);
				if  ($numrows5!=0) 
					{   
						...
						echo "<tr align='center'><th >Codigo</th><th >Fecha</th><th >Detalle</th><th>Cantidad</th><th>Total</th></tr>";	
						while ($row1=pg_fetch_array($result)) 
							{ 
											...
											$cantidad=$row1["3"];
											$total=$row1["4"];
											echo "<tr  align='center'><td >".$codigo."</td><td >".$fecha."</td><td>".$detalle."</td><td >".$cantidad."</td><td >".$total."</td></tr>";	
...
echo "<div class='cons2'><p>Rotar el dispositivo para poder observar los datos de la consulta</p></div><br/>";
						echo "<FORM ACTION='eliminar.php' METHOD='POST'>
												  <P align='center'><input type='hidden' name='tabla' value='pedido'><input type='hidden' name='codigo' value='$codigo'><input width='30%' class='button' type='submit' value='Eliminar'></p>
												  </FORM>
...

					{
											...
											echo "<table width='50%'><FORM ACTION='cons_pedido.php' METHOD='POST'><tr><td>
												  <P align='center'>NO HAY DATOS DE PEDIDO</p></td></tr>
