...
<head>
	...
	<meta charset="utf-8">
	<title>Eliminacion Decorativo </title>
...
<div class="cuerpo">
<h1 align="center">Eliminar Decorativo</h1>
<div align="center">
<?PHP
// llamar la funciones 
   include("../conec.php");
	...
	$numrows5 = pg_numrows($result);
				if  ($numrows5!=0) 
					{   
						...
						echo "<tr align='center'><th >Codigo</th><th >Nombre</th><th >Detalles</th></tr>";	
						while ($row1=pg_fetch_array($result)) 
							{ 
											$codigo=$row1["0"];
											$nombre=$row1["1"];
											$detalles=$row1["2"];
											echo "<tr  align='center'><td >".$codigo."</td><td >".$nombre."</td><td>".$detalles."</td></tr>";	
...
echo "<div class='cons2'><p>Rotar el dispositivo para poder observar los datos de la consulta</p></div><br/>";
						echo "<FORM ACTION='eliminar.php' METHOD='POST'>
												  <P align='center'><input type='hidden' name='tabla' value='decorativo'><input type='hidden' name='codigo' value='$codigo'><input width='30%' class='button' type='submit' value='Eliminar'></p>
												  </FORM>
...

					{
											...
											echo "<table width='50%'><FORM ACTION='cons_decorativo.php' METHOD='POST'><tr><td>
												  <P align='center'>NO HAY DATOS DE DECORATIVO</p></td></tr>
