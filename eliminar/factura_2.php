...
<head>
	...
	<meta charset="utf-8">
	<title>Eliminacion Factura </title>
...
<div class="cuerpo">
<h1 align="center">Eliminar Factura</h1>
<div align="center">
<?PHP
// llamar la funciones 
   include("../conec.php");
	...
	$numrows5 = pg_numrows($result);
				if  ($numrows5!=0) 
					{   
						...
						echo "<tr align='center'><th >Codigo</th><th >Fecha</th><th >Impuestos</th><th>Total</th></tr>";	
						while ($row1=pg_fetch_array($result)) 
							{ 
											...
											$impuestos=$row1["2"];
											$total=$row1["3"];
											echo "<tr  align='center'><td >".$codigo."</td><td >".$fecha."</td><td >".$impuestos."</td><td>".$total."</td></tr>";	
...
echo "<div class='cons2'><p>Rotar el dispositivo para poder observar los datos de la consulta</p></div><br/>";
						echo "<FORM ACTION='eliminar.php' METHOD='POST'>
												  <P align='center'><input type='hidden' name='tabla' value='factura'><input type='hidden' name='codigo' value='$codigo'><input width='30%' class='button' type='submit' value='Eliminar'></p>
												  </FORM>
...

					{
											...
											echo "<table width='50%'><FORM ACTION='cons_factura.php' METHOD='POST'><tr><td>
												  <P align='center'>NO HAY DATOS DE FACTURA</p></td></tr>
