...
<div class ="cabecera">
			...
			<ul class="submenu">
					...
					<li><a href="javascript:window.open('consultar/cons_derivados.php', target='popup', 'top=37, left=0, width=799,height=421,menubar=no,scrollbars=no,status=no,titlebar=no,toolbar=no,directories=no,location=no');" > DERIVADOS </a></li>					
				</ul>
			</li>
