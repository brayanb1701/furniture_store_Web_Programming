...
<div class ="cabecera">
			<ul class = "menu">
				...
				<ul class="submenu">		
					<li><a href="javascript:window.open('insertar/pedido.php', target='popup', 'menubar=no,scrollbars=no,status=no,titlebar=no,toolbar=no,directories=no,location=no');" > PEDIDO </a></li>
				</ul>
			</li>
			...
			<li><a href=""> PERFIL </a>
				<ul class="submenu">
					<li><a href="actualizar_cli.php"> ACTUALIZAR </a></li>
					<li><a href="eliminar_cli.php"> ELIMINAR </a></li>
				</ul>
			</li>
