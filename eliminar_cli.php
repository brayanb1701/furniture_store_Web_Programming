...
<head>
	...
	<meta charset="utf-8">
	<title>Eliminacion Clientes </title>
	...
	$numrows5 = pg_numrows($result);
				if  ($numrows5!=0) 
					{   
						...
						echo "<tr align='center'><th >Usuario</th><th>Nombres</th><th>Apellidos</th><th>Codigo</th><th>Rol</th></tr>";	
						while ($row1=pg_fetch_array($result)) 
							{ 
											...
											$apellidos=$row1["4"];
											$rol=$row1["5"];
											echo "<tr  align='center'><td >".$usuario."</td><td>".$nombres."</td><td>".$apellidos."</td><td>".$codigo."</td><td>".$rol."</td></tr>";	
...
echo "<div class='cons2'><p>Rotar el dispositivo para poder observar los datos de la consulta</p></div><br/>";
						echo "<FORM ACTION='eliminar.php' METHOD='POST'>
												  <P align='center'><input type='hidden' name='tabla' value='usuario'><input type='hidden' name='codigo' value='$codigo'><input width='30%' class='button cons_but' type='submit' value='Eliminar'></p>
												  </FORM><br>
...

					{
											...
											echo "<table width='50%'><FORM ACTION='client.php' METHOD='POST'><tr><td>
